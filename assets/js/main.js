...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to Web Terminal!\nIn order to get started, feel free to execute the 'help' command.\nIn order to skip text rolling, double click/touch anywhere.",
...
var Terminal = function (prompt, cmdLine, output, user, host, root) {
    ...
    this.output = output;
    this.typeSimulator = new TypeSimulator(output);
};
...
var TypeSimulator = function (output) {
